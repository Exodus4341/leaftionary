<?php echo Form::open(); ?>
	...
	<fieldset>
		...
		<div class="clearfix">
			...
			<div class="input">
				<?php echo Form::input('active', Input::post('active', isset($user) ? $user->active : ''), array('class' => 'span4')); ?>
		...
		<div class="clearfix">
			...
			<div class="input">
				<?php echo Form::input('type', Input::post('type', isset($user) ? $user->type : ''), array('class' => 'span4')); ?>
